$(document).ready(function () {
  ...
  function refreshForm() {
    ...
    const tanggal =
      parseFloat(dateNow.getDate()) < 10
        ? "0" + dateNow.getDate()
        : dateNow.getDate();
    const bulan =
      parseFloat(dateNow.getMonth()) + 1 < 10
    ...
    isValidTanggal = true;
    $("#namaUserErr1").text("");
    isValidSelectedUser = true;
    $("#namaItemErr1").text("");
    isValidNamaItem = true;
    $("#jumlahErr1").text("");
    isValidJumlah = true;
    $("#nominalErr1").text("");
    isValidNominal = true;
  ...
  function validationForm() {
    ...
    if (!$("#selectedNamaUser").val()) {
      $("#namaUserErr1").text("Nama User harus di isi");
      isValidSelectedUser = false;
    } else {
      $("#namaUserErr1").text("");
      isValidSelectedUser = true;
    }
    ...
    if (!$("#namaItem").val()) {
      $("#namaItemErr1").text("Nama item harus di isi");
      isValidNamaItem = false;
    } else {
      $("#namaItemErr1").text("");
      isValidNamaItem = true;
    }
    ...
    if (!$("#jumlah").val()) {
      $("#jumlahErr1").text("Jumlah harus di isi");
      isValidJumlah = false;
    } else {
      $("#jumlahErr1").text("");
      isValidJumlah = true;
    ...
    if (!$("#nominal").val()) {
      $("#nominalErr1").text("Nominal harus di isi");
