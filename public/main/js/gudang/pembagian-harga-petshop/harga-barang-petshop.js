$(document).ready(function () {
  ...
  $(".openFormAdd").click(function () {
    modalState = "add";
    $(".modal-title").text("Tambah Pembagian Harga Barang Petshop");
  ...
  $(".btn-download-excel").click(function () {
    $.ajax({
      url: $(".baseUrl").val() + "/api/pembagian-harga-barang-petshop/generate-excel",
  ...
  $(".btn-download-template").click(function () {
    $.ajax({
      url:
        $(".baseUrl").val() + "/api/pembagian-harga-barang-petshop/download-template",
      headers: { Authorization: `Bearer ${token}` },
      type: "GET",
      xhrFields: { responseType: "blob" },
      beforeSend: function () {
  ...
  $("#fileupload")
    .fileupload({
      url: $(".baseUrl").val() + "/api/pembagian-harga-barang-petshop/upload",
      headers: { Authorization: `Bearer ${token}` },
      dropZone: "#dropZone",
      dataType: "json",
      autoUpload: false,
  ...
  $("#selectedCabangOnBarang").on("select2:select", function (e) {
    if ($(this).val()) {
      ...
      $("#selectedNamaBarang").attr("enabled", true);
  ...
  function loadBarangPetShop(idCabang, itemCategoriesId = null) {
    $.ajax({
      url: $(".baseUrl").val() + "/api/pembagian-harga-barang-petshop/barang-petshop",
      headers: { Authorization: `Bearer ${token}` },
      type: "GET",
      data: { branch_id: idCabang },
      beforeSend: function () {
      ...
      success: function (data) {
        ...
        if (modalState == "edit") {
          $("#selectedNamaBarang").val(itemCategoriesId);
  ...
  //   $.ajax({
  //     url: $(".baseUrl").val() + "/api/pembagian-harga-barang-petshop/nama-barang",
  //     headers: { Authorization: `Bearer ${token}` },
  //     type: "GET",
  ...
  function validationForm() {
    ...
    let hargaJual  = $('#hargaJualOnBarang').val().replaceAll('.', '');
    let hargaModal = $('#hargaModalOnBarang').val().replaceAll('.', '');
