    ...
    public function index(Request $request)
    {
        ...
        $data = DB::table('payrolls as py')
            ...
            ->select(
                ...
                'py.percentage_turnover as percentage_turnover',
                'py.amount_turnover as amount_turnover',
                'py.total_turnover as total_turnover',
                'py.amount_inpatient as amount_inpatient',
                'py.count_inpatient as count_inpatient',
                'py.total_inpatient as total_inpatient',
                'py.percentage_surgery as percentage_surgery',
                'py.amount_surgery as amount_surgery',
