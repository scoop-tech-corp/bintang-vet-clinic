...
<head>
  ...
  <title>Sistem Administrasi Go Vet Clinic | Masuk</title>
...
<div class="login-box" id="login-app">
  <input ref="baseUrl" type="hidden" value="{{ url('/') }}"/>
    ...
    <div class="header-login-section">
      <div class="title-login">Sistem Administrasi Go Vet Clinic</div>
      <img src="{{ asset('assets/image/logo-govet.jpg') }}">
    </div>
