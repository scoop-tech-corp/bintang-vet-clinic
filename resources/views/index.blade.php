                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="onOrdering" data='total_item' orderby="none">Jumlah <span
                                            class="fa fa-sort"></span></th>
                                    <th class="onOrdering" data='unit_name' orderby="none">Satuan <span
                                            class="fa fa-sort"></span></th>
                    ...
                    <div style="display: flex; justify-content: space-between">
                        ...
                        <div class="box-tools">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control" id="datepicker-jumlah-pasien"
                        ...
                        <div class="box-tools">
                            <div class="rawat-inap-datepicker">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control" id="datepicker-rawat-inap"
