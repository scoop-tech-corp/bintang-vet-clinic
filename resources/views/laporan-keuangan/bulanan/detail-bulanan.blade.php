...
@section('content')
<div class="box box-info" id="detail-laporan-keuangan-bulanan-app">
  <div class="box-header">
    <h3 class="box-title">Detail Laporan Keuangan Bulanan</h3>
  </div>

  <div class="box-body">
    <div class="btn-back-to-list">
      <span class="fa fa-arrow-left"></span> <span class="text">Daftar Laporan Keuangan Bulanan</span>
    </div>
...
@section('script-content')
  <script src="{{ asset('main/js/laporan-keuangan/bulanan/detail-bulanan.js') }}"></script>
@endsection
@section('css-content')
