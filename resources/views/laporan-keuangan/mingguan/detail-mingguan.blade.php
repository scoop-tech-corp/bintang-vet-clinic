...
@section('content')
<div class="box box-info" id="detail-laporan-keuangan-mingguan-app">
  <div class="box-header">
    <h3 class="box-title">Detail Laporan Keuangan Mingguan</h3>
  </div>

  <div class="box-body">
    <div class="btn-back-to-list">
      <span class="fa fa-arrow-left"></span> <span class="text">Daftar Laporan Keuangan Mingguan</span>
    </div>
...
@section('script-content')
  <script src="{{ asset('main/js/laporan-keuangan/mingguan/detail-mingguan.js') }}"></script>
@endsection
@section('css-content')
