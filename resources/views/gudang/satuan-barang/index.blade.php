...
@section('content')
<div class="box box-info" id="satuan-barang-app">
    ...
    <div class="table-responsive">
      <table class="table table-striped text-nowrap">
        <thead>
          <tr>
            <th>No</th>
            <th @click="onOrdering('unit_name')">Satuan Barang
              <span v-if="columnStatus.unit_name == 'desc'" class="fa fa-sort-desc"></span>
              <span v-if="columnStatus.unit_name == 'asc'" class="fa fa-sort-asc"></span>
              <span v-if="columnStatus.unit_name == 'none'" class="fa fa-sort"></span>
            </th>
        ...
        <tbody>
          ...
          <tr class="text-center" v-if="!listData.length">
