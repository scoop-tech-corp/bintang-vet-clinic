...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	<link rel="shortcut icon" type="image/jpg" href="{{ asset('assets/image/cosmo-image.jpeg') }}">
  <!-- Bootstrap 3.3.7 -->
    ...
    <input class="baseUrl" type="hidden" value="{{ url('/') }}"/>
		<header class="main-header">
			...
			<a href="{{ url('/') }}" class="logo">
				...
				<span class="logo-lg"><b>COSMO</b> <b>VET</b> CLINIC</span>
			</a>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="/">Cosmo Vet Clinic</a></strong> | Powered by Scoop Tech
		</footer>
